...
if (count($_POST) > 0) {
    if (verify_post('price_email')) {
        $str = "E-mail: " . $_POST['price_email'];
        do_send($str);
...
function do_send($str) {
    ...
    $mail->Subject    = 'Запрос цены терминала с Страховойтерминал.рф';
    ...
    $mail3->Subject    = 'Запрос цены терминала с Страховойтерминал.рф';
    ...
    $mail3->Send();
    /*$to      = 'Info@stfilin.ru';
    $subject = 'Запрос цены терминала с Страховойтерминал.рф';
    $message = "E-mail: " . $_POST['price_email'];
